"""The liveness file behind the historian's container healthcheck."""
...
from historian.liveness import LivenessFile, is_fresh, main
...
def test_a_new_subscriber_is_not_connected() -> None:
    assert HistorianSubscriber(writer=MagicMock()).connected is False
